...
# GLOBAL VARIABLES DECLARED HERE....# Started from Tello Template
# This Python app is in the Public domain
# Some parts from Tello3.py
#wifi adress D8DDCF
import threading, socket, sys, time, subprocess
...
try:
    if ready.lower() == 'yes':
        ...
        sendmsg('command', 0)
        sendmsg('takeoff')
        sendmsg("go 189 0 60 50")
        sendmsg("go 210 0 70 50", 9)
        sendmsg("curve 130 80 0 123 123 0 50")
        sendmsg("ccw 90", 9)
        sendmsg("curve 130 80 0 123 123 0 50")
        sendmsg("ccw 90", 9)
...
try:
    if ready.lower() == 'yes':
        ...
        sendmsg("curve 125 75 0 123 123 0 50")
        sendmsg("ccw 90")
        sendmsg("curve 125 75 0 123 123 0 50")
        sendmsg("ccw 90")
        sendmsg("go 210 0 -80 50")
